...
class PointTests {
    ...
    void distanceSquared() {
        ...
        assertEquals(17469.661, point1.distanceSquared(point2), 0.00000001, "Distance squared between two different points is not correct");

        // TC02: distance squared between same points
        assertTrue(Util.isZero(point1.distanceSquared(point1)), "Distance squared between same points is not 0");
    }
    ...
    void distance() {
        ...
        Point point1 = new Point(-3.6, 100.21, -1.5);
        Point point2 = new Point(-74.64, 1.96, -54.13);
        assertEquals(Math.sqrt(17469.661), point1.distance(point2), 0.00000001, "Distance between two different points is not correct");

        // TC02: distance between same points
        assertTrue(Util.isZero(point1.distance(point1)), "Distance between same points is not 0");
    }
}